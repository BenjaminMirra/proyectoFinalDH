  ...
  return (
    <div className='wrapper'>
      ...
      <div className='contenedor-pagina' >
        ...
        <LocationInfo location={productData.ciudad_id==1?'San Carlos de Bariloche, Río Negro, Argentina':productData.ciudad_id==2?'Buenos Aires, Ciudad Autónoma de Buenos Aires, Argentina':productData.ciudad_id==3?'Mendoza, Mendoza, Argentina':'Córdoba, Córdoba, Argentina'} rating={productData.puntaje} />
