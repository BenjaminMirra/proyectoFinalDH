    ...
    <div className="card-product">
      ...
      <div className="card-product-text">
        ...
        <div className="product-location">
          ...
          <Paragraph size="md" variant="secondary">{location} <Span size="md" variant="aqua"> MOSTRAR EN EL MAPA</Span></Paragraph>
        </div>
      ...
      <div className="product-description">
        <Paragraph size="md" variant="secondary">{descripcion}</Paragraph>
