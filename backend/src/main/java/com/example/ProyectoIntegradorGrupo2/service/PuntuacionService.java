...
public class PuntuacionService implements IPuntuacionService{
    ...
    public PuntuacionDTO agregarPuntuacion(PuntuacionDTO puntuacionDTO) throws BadRequestException {
        ...
        if ((puntuacionDTO.getPuntuacion() < 1 || puntuacionDTO.getPuntuacion() > 5) || (puntuacionDTO.getPuntuacion()%1 != 0)) throw new BadRequestException("La puntuación debe ser un numero entero del 1 al 5");
